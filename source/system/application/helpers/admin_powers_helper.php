...
function admin_powers () {
    ...
    // Add power that blankets viewing for the entire admin section of the site
    // Add power to reset a user's password
    $edit_user_password             = new Power();
    $edit_user_password->action     = 'view';
    $edit_user_password->item       = 'admin_section';
    $edit_user_password->title      = 'View any part of the admin section.';
