...
web build:
 - http://mootools.net/core/7c81f2f8366dfebb953c3e9e1c3fdc5f

packager build:
 - packager build Core/Event Core/Element Core/Element.Event Core/DOMReady
...
for(var e=g[0];e--;){h=h.firstChild;}this.empty().adopt(h.childNodes);}else{this.innerHTML=f;}}};b.erase=b.set;return b;})();(function(){Element.Properties.events={set:function(c){this.addEvents(c);
